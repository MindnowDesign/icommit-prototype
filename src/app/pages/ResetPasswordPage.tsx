...
const RESET_COPY = {
  ...
  de: {
    ...
    subtitle:
      "Legen Sie ein sicheres Passwort fest, um die Wiederherstellung abzuschließen.",
    ...
    rulesTitle: "Ihr Passwort muss Folgendes enthalten:",
    ...
    toastPasswordRequiredDesc: "Bitte geben Sie ein neues Passwort ein und bestätigen Sie es.",
    toastRulesTitle: "Passwort zu schwach",
    toastRulesDesc: "Bitte erfüllen Sie alle Passwortregeln.",
    ...
    toastSuccessDesc: "Sie können sich jetzt mit Ihrem neuen Passwort anmelden.",
  },
