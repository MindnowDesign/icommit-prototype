...
/**
 * Phase 3: max 6 total across ALL tabs (sample stars on ig2, ig4 commitment; ig2 sat; ig3, ig4 res).
 */
const COMMITMENT_POS: TabPos[] = [
  { x: -0.65, y: 0.42, hausRelative: "strength", isUserAction: false },
  { x: 0.18, y: 0.55, hausRelative: "strength", isUserAction: true },
  { x: 0.72, y: -0.12, hausRelative: "weakness", isUserAction: false },
  { x: -0.35, y: -0.58, hausRelative: "weakness", isUserAction: true },
  { x: 0.45, y: 0.22, hausRelative: "strength", isUserAction: false },
  { x: -0.08, y: 0.68, isUserAction: false },
  { x: 0.55, y: -0.35, hausRelative: "weakness", isUserAction: false },
  { x: -0.82, y: 0.15, isUserAction: false },
  { x: 0.28, y: 0.38, isUserAction: false },
  { x: -0.22, y: -0.25, isUserAction: false },
  { x: 0.62, y: 0.08, isUserAction: false },
  { x: -0.48, y: -0.05, isUserAction: false },
...
const SATISFACTION_POS: TabPos[] = [
  { x: 0.35, y: 0.48, hausRelative: "strength", isUserAction: true },
  { x: -0.55, y: -0.42, hausRelative: "weakness", isUserAction: false },
  { x: 0.68, y: 0.12, hausRelative: "strength", isUserAction: false },
  { x: -0.12, y: 0.62, hausRelative: "strength", isUserAction: false },
  { x: 0.22, y: -0.18, hausRelative: "weakness", isUserAction: false },
  { x: -0.38, y: 0.35, isUserAction: false },
  { x: 0.52, y: -0.55, hausRelative: "weakness", isUserAction: true },
  { x: -0.72, y: 0.08, isUserAction: false },
  { x: 0.08, y: 0.25, isUserAction: false },
  { x: -0.25, y: -0.48, isUserAction: false },
  { x: 0.78, y: -0.28, isUserAction: false },
  { x: -0.05, y: 0.52, isUserAction: false },
  ...
  { x: 0.12, y: 0.55, isUserAction: false },
];

const RESIGNATION_POS: TabPos[] = [
  { x: -0.58, y: 0.65, hausRelative: "strength", isUserAction: false },
  { x: 0.42, y: -0.62, hausRelative: "weakness", isUserAction: false },
  { x: 0.65, y: 0.28, hausRelative: "strength", isUserAction: true },
  { x: -0.28, y: -0.38, hausRelative: "weakness", isUserAction: true },
  { x: 0.15, y: 0.18, isUserAction: false },
  { x: -0.85, y: 0.42, hausRelative: "weakness", isUserAction: false },
  { x: 0.55, y: -0.15, hausRelative: "strength", isUserAction: false },
  { x: -0.15, y: -0.55, isUserAction: false },
  { x: 0.32, y: 0.48, isUserAction: false },
  { x: -0.45, y: -0.22, isUserAction: false },
  { x: 0.78, y: 0.05, isUserAction: false },
  { x: -0.68, y: -0.08, isUserAction: false },
